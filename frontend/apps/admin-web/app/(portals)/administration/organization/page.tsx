    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-[#605e5c]">
          Office master data for Portal 35.3. Sites and gates stay under Branch
          Ops. Super Admin 35.1 keeps the same enterprise APIs for ICT.
        </p>
      </div>
      {error ? (
      ...
      <GlassCard glow="none" className="p-4">
        <h2 className="text-sm font-semibold">Company record</h2>
        {loading && !org ? (
            ...
            {branches.map((b) => (
              ...
              >
                <span>
                  ...
                  {b.region ? (
                    <span className="text-[#605e5c]"> · {b.region}</span>
                  ) : null}
                </span>
                {canMutate ? (
                  <button
                  ...
                  <button
                    ...
                    onClick={() =>
                      void updateDepartment(d.id, {
                        isActive: !d.isActive,
                      }).then(refresh, (err) => setError(formatApiError(err)))
                    }
                  >
