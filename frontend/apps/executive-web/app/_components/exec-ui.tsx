...
> = {
  ...
  PATROL_SCANS: {
    hint: 'Checkpoint scans completed in the selected period.',
    Icon: MapPin,
    adminHref: adminWebUrl('/branch/patrols'),
    adminLabel: 'Patrols',
  },
  FIELD_ALERTS_OPEN: {
  ...
  CUSTOMER_SITES_ACTIVE: {
    hint: 'Active sites linked to customer accounts.',
    Icon: MapPin,
    adminHref: adminWebUrl('/branch'),
    adminLabel: 'Customer sites',
  },
  CUSTOMERS_ACTIVE: {
  ...
  VEHICLE_ACCESS_ALLOWED: {
    hint: 'Vehicle entry/exit decisions allowed in the selected period.',
    Icon: CheckCircle2,
    adminHref: parkingWebUrl('/entries'),
    adminLabel: 'Vehicle access',
  },
  PARKING_OCCUPANCY_RATE: {
    hint: 'Occupied plus reserved active bays as a share of active spaces.',
    Icon: Percent,
    adminHref: parkingWebUrl('/spaces'),
    adminLabel: 'Parking spaces',
  },
  PARKING_PERMITS_ACTIVE: {
    hint: 'Parking permits currently ACTIVE.',
    Icon: FileCheck2,
    adminHref: parkingWebUrl('/permits'),
    adminLabel: 'Parking permits',
  },
  PARKING_VIOLATIONS: {
  ...
  VISITOR_APPOINTMENTS: {
    hint: 'Visitor appointments created in the selected period.',
    Icon: Users,
    adminHref: adminWebUrl('/callcentre'),
    adminLabel: 'Visitor appointments',
  },
  VISITOR_ENTRIES_ALLOWED: {
    hint: 'Allowed visitor entry and exit verification records.',
    Icon: CheckCircle2,
    adminHref: adminWebUrl('/callcentre'),
    adminLabel: 'Gate verification',
  },
  GATE_VERIFICATIONS: {
    hint: 'All visitor gate decisions, with allowed and denied breakdown.',
    Icon: Shield,
    adminHref: adminWebUrl('/callcentre'),
    adminLabel: 'Gate log',
  },
  CUSTOMER_EMPLOYEE_ACCESS_EVENTS: {
    hint: 'Customer employee check-in and check-out events.',
    Icon: Users,
    adminHref: adminWebUrl('/superadmin/customers'),
    adminLabel: 'Customer employees',
  },
  CONTRACTS_MRR: {
  ...
  PETTY_CASH_ISSUED: {
    hint: 'Approved petty cash actually issued in the selected period.',
    Icon: Wallet,
    adminHref: adminWebUrl('/finance/petty-cash'),
    adminLabel: 'Petty cash',
  },
  PAYMENT_VOUCHERS_PAID: {
    hint: 'Value of payment vouchers marked PAID in the period.',
    Icon: FileCheck2,
    adminHref: adminWebUrl('/finance'),
  ...
  CUSTOMER_PAYROLL_NET_TOTAL: {
    hint: 'Customer-managed payroll net value from immutable payslip snapshots.',
    Icon: CreditCard,
    adminHref: adminWebUrl('/payroll'),
    adminLabel: 'Customer payroll',
  },
  EPAYROLL_DUE_ALERTS: {
    hint: 'Electronic payroll alerts currently due in the selected period.',
    Icon: Bell,
    adminHref: adminWebUrl('/payroll'),
    adminLabel: 'Payroll due alerts',
  },
  EMPLOYEE_LOANS_ACTIVE: {
    hint: 'Employee loans currently ACTIVE and being recovered.',
    Icon: Wallet,
  ...
  B2B_RECRUITMENT_REQUESTS_OPEN: {
    ...
    Icon: Users,
    adminHref: adminWebUrl('/hr/b2b-requests'),
    adminLabel: 'B2B recruitment',
  },
  SUPPLIERS_APPROVED: {
    hint: 'Suppliers approved for procurement transactions.',
    Icon: Briefcase,
    adminHref: adminWebUrl('/procurement'),
    adminLabel: 'Suppliers',
  },
  CUSTOMER_SERVICE_RESOLUTION_RATE: {
    hint: 'Resolved or closed complaints and service requests in the period.',
    Icon: Percent,
    adminHref: adminWebUrl('/callcentre'),
    adminLabel: 'Customer service',
  },
  CCTV_ALERTS_OPEN: {
    hint: 'CCTV events still received or failed and awaiting triage.',
    Icon: Radio,
    adminHref: adminWebUrl('/cctv'),
    adminLabel: 'CCTV monitoring',
  },
  AUDIT_EVENTS: {
    hint: 'Auditable actions recorded in the selected period.',
    Icon: FileText,
    adminHref: adminWebUrl('/compliance'),
    adminLabel: 'Audit logs',
  },
};
...
export function DomainCoveragePanel({
  ...
  const rows: {
    ...
    },
    {
      ...
      design: 'clock-ins and approvals',
      code: 'ATTENDANCE_CLOCK_INS',
      category: 'OPS',
      href: adminWebUrl('/branch/attendance'),
      hrefLabel: 'Attendance',
    },
    {
      label: 'Guard alertness',
      design: 'confirmation rate',
      code: 'ALERTNESS_CONFIRM_RATE',
      category: 'OPS',
      href: adminWebUrl('/branch/attendance'),
      hrefLabel: 'Alertness',
    },
    {
      label: 'Customer employee attendance',
      design: 'access events',
      code: 'CUSTOMER_EMPLOYEE_ACCESS_EVENTS',
      category: 'ACCESS',
      href: adminWebUrl('/superadmin/customers'),
      hrefLabel: 'Employees',
    },
    {
      ...
      design: 'appointment volume',
      code: 'VISITOR_APPOINTMENTS',
      category: 'ACCESS',
      href: adminWebUrl('/callcentre'),
      hrefLabel: 'Visitors',
    },
    {
      label: 'Gate verification',
      design: 'allowed and denied',
      code: 'GATE_VERIFICATIONS',
      category: 'ACCESS',
      href: adminWebUrl('/callcentre'),
      hrefLabel: 'Gate log',
    },
    {
      ...
      design: 'active bay utilization',
      code: 'PARKING_OCCUPANCY_RATE',
      category: 'ACCESS',
      href: parkingWebUrl('/spaces'),
      hrefLabel: 'Spaces',
    },
    {
      label: 'Vehicle access',
      design: 'allowed movements',
      code: 'VEHICLE_ACCESS_ALLOWED',
      category: 'ACCESS',
      href: parkingWebUrl('/entries'),
      hrefLabel: 'Entries',
    },
    {
      label: 'Parking permits',
      design: 'active permits',
      code: 'PARKING_PERMITS_ACTIVE',
      category: 'ACCESS',
      href: parkingWebUrl('/permits'),
      hrefLabel: 'Permits',
    },
    {
      label: 'Parking violations',
      design: 'violations recorded',
      code: 'PARKING_VIOLATIONS',
      category: 'ACCESS',
      href: parkingWebUrl('/violations'),
      hrefLabel: 'Violations',
    },
    {
      label: 'Employee loans',
      design: 'active recovery',
      code: 'EMPLOYEE_LOANS_ACTIVE',
      category: 'HR',
      href: adminWebUrl('/loans'),
      hrefLabel: 'Loans',
    },
    {
      label: 'Customer payroll',
      design: 'immutable net snapshots',
      code: 'CUSTOMER_PAYROLL_NET_TOTAL',
      category: 'PAYROLL',
      href: adminWebUrl('/payroll'),
      hrefLabel: 'Payroll',
    },
    {
      label: 'E-payroll due alerts',
      design: 'fully-paid invoice gate',
      code: 'EPAYROLL_DUE_ALERTS',
      category: 'PAYROLL',
      href: adminWebUrl('/payroll'),
      hrefLabel: 'Due alerts',
    },
    {
      label: 'Payments',
      design: 'invoice collections',
    ...
    {
      label: 'Petty cash',
      design: 'cash actually issued',
      code: 'PETTY_CASH_ISSUED',
      category: 'FINANCE',
      href: adminWebUrl('/finance/petty-cash'),
      hrefLabel: 'Petty cash',
    },
    {
      label: 'Payment vouchers',
      design: 'paid voucher value',
      code: 'PAYMENT_VOUCHERS_PAID',
      category: 'FINANCE',
      href: adminWebUrl('/finance'),
      hrefLabel: 'Vouchers',
    },
    {
      label: 'Suppliers',
      design: 'approved supplier base',
      code: 'SUPPLIERS_APPROVED',
      category: 'COMMERCIAL',
      href: adminWebUrl('/procurement'),
      hrefLabel: 'Suppliers',
    },
    {
      label: 'B2B recruitment',
      design: 'other security requests',
      code: 'B2B_RECRUITMENT_REQUESTS_OPEN',
      category: 'HR',
      href: adminWebUrl('/hr/b2b-requests'),
      hrefLabel: 'B2B requests',
    },
    {
      label: 'Customer sites',
      design: 'active service footprint',
    ...
    {
      label: 'Patrols',
      design: 'checkpoint confirmations',
      code: 'PATROL_SCANS',
      category: 'OPS',
      href: adminWebUrl('/branch/patrols'),
      hrefLabel: 'Patrols',
    },
    {
      label: 'CCTV monitoring',
      design: 'alerts awaiting triage',
      code: 'CCTV_ALERTS_OPEN',
      category: 'SAFETY',
      href: adminWebUrl('/cctv'),
      hrefLabel: 'CCTV',
    },
    {
      label: 'Audit logs',
      design: 'accountability events',
      code: 'AUDIT_EVENTS',
      category: 'COMPLIANCE',
      href: adminWebUrl('/compliance'),
      hrefLabel: 'Audit',
    },
    {
      ...
      design: 'resolution performance',
      code: 'CUSTOMER_SERVICE_RESOLUTION_RATE',
      category: 'COMMERCIAL',
      href: adminWebUrl('/callcentre'),
      hrefLabel: 'Service',
    },
