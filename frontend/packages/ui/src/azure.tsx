...
export function moduleVisual(href: string): { glyph: GlyphName; color: string } {
  const map: Array<[string, { glyph: GlyphName; color: string }]> = [
    ...
    ['/ess', { glyph: 'user-check', color: '#0ea5e9' }],
    ['/loans', { glyph: 'wallet', color: '#7c3aed' }],
    ['/payroll', { glyph: 'wallet', color: '#8b5cf6' }],
    ['/finance/petty-cash', { glyph: 'coins', color: '#15803d' }],
    ['/finance', { glyph: 'coins', color: '#16a34a' }],
    ['/submissions', { glyph: 'clipboard', color: '#ea580c' }],
    ['/assets/returns', { glyph: 'box', color: '#ea580c' }],
    ['/assets', { glyph: 'box', color: '#f97316' }],
    ['/procurement/inventory', { glyph: 'box', color: '#c2410c' }],
    ['/procurement', { glyph: 'cart', color: '#f97316' }],
    ['/cctv', { glyph: 'video', color: '#64748b' }],
    ['/devices', { glyph: 'layers', color: '#0369a1' }],
    ['/branch/sites', { glyph: 'building', color: '#0f766e' }],
    ['/branch/deployments', { glyph: 'shield-user', color: '#0d9488' }],
    ['/branch/shifts', { glyph: 'calendar', color: '#14b8a6' }],
    ['/branch/attendance', { glyph: 'clipboard', color: '#0d9488' }],
    ['/branch/alerts', { glyph: 'alert', color: '#dc2626' }],
    ['/branch/eob', { glyph: 'book', color: '#0f766e' }],
    ['/branch/patrols', { glyph: 'key', color: '#0891b2' }],
    ['/branch/incidents', { glyph: 'alert', color: '#b91c1c' }],
    ['/branch', { glyph: 'branch', color: '#0d9488' }],
    ['/compliance/policies', { glyph: 'clipboard', color: '#0369a1' }],
    ['/compliance/breaches', { glyph: 'alert', color: '#b91c1c' }],
    ...
    ['/access', { glyph: 'users', color: '#0ea5e9' }],
    ['/visitors', { glyph: 'user-check', color: '#0284c7' }],
    ['/parking', { glyph: 'car', color: '#7c3aed' }],
    ['/incidents', { glyph: 'alert', color: '#b91c1c' }],
    ['/invoices', { glyph: 'coins', color: '#16a34a' }],
    ['/requests', { glyph: 'headset', color: '#e11d48' }],
