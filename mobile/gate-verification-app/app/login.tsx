...
import { ADMIN_LOGIN_FALLBACK, DEFAULT_LOGIN } from '@/constants/config';
...
export default function LoginScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Text style={styles.title}>Gate Verify</Text>
      <Text style={styles.sub}>
        Online-only visitor OTP · core-api :4001
      </Text>
      ...
      <View style={styles.form}>
        ...
        <TextInput
          ...
          editable={!busy}
        />
        <Text style={styles.hint}>{ADMIN_LOGIN_FALLBACK}</Text>
