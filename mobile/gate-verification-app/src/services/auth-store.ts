...
const ACCESS_TOKEN_KEY = 'pssms.gate.accessToken';
const REFRESH_TOKEN_KEY = 'pssms.gate.refreshToken';
const USER_JSON_KEY = 'pssms.gate.user';
...
export async function getStoredUser(): Promise<GateUser | null> {
