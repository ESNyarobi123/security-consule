...
if ! git show HEAD:infra/docker/docker-compose.prod.yml | grep -q '0069_risk_register'; then
  echo "FATAL: compose missing 0069 migration list"
  exit 1
fi
